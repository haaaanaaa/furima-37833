...
RSpec.describe PurchaseForm, type: :model do
  before do
    ...
    @purchase = FactoryBot.build(:purchase_form, product_id: @product.id, user_id: @user.id)
  ...
  describe '配送先情報の保存' do
    ...
    context '配送先情報の保存ができないとき' do
      ...
      it '郵便番号が空だと保存できないこと' do
        ...
        @purchase_form.valid?
        expect(@purchase_form.errors.full_messages).to include("Postal code can't be blank", 'Postal code is invalid. Include hyphen(-)')
      end
